...
fun DaftarData(
    ...
    )
    {
        ...
        // Memberi jarak antara Card terakhir (Alamat) dengan tombol pertama
        ...
        // Spacer tambahan di bawah untuk estetika jika konten bisa di-scroll
